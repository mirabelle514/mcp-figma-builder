...
This guide shows you **exactly where to make changes** when you want to use your own component repository and Figma library instead of the default the design system/the design system setup.
  ...
  "mcpServers": {
    "components-figma": {
      ...
      "env": {
        ...
        "REPO_NAME": "YOUR_DESIGN_SYSTEM_REPO"
      }
    }
  }
}
...
```json
{
  "mcpServers": {
    "material-figma": {
      "command": "node",
      "args": ["/Users/you/projects/components-figma-mcp/mcp-server/dist/index.js"],
      "env": {
...
**File:** `mcp-server/src/services/components-scanner.ts`
...
- [ ] Updated `REPO_OWNER` to your org/username
- [ ] Updated `REPO_NAME` to your repo name
...
"REPO_OWNER": "your-org",        // Required
"REPO_NAME": "your-repo",        // Required
...
- **Different framework?** Customize `components-scanner.ts`
