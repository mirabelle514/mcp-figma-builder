...
**1. Clone and install:**
```bash
git clone https://github.com/mirabelledoiron/mcp-starter-repo
cd mcp-starter-repo
npm install
```
...
- Try: `Scan the components repository`
...
- Header: Use Header with HeaderSection
- Button: Use Button with fill="primary"
- Card: Use Card with layout="horizontal"
...
- [ ] Component library (e.g., "mui/material-ui")
...
#### Screen 2: Repository
- Enter GitHub owner (e.g., `mui`)
- Enter repository name (e.g., `components`)
...
```
Scan the components repository
```
...
Requirements:
- Use FlexGroup for layout
- Use Card for the main container
- Use Button with color="primary" for the CTA
- Make it responsive
```
...
- Dark mode support using the design system theme
...
```bash
npm install @design-system/components  # or your component library
```
...
```
 Good:
1. Scan the components repository
