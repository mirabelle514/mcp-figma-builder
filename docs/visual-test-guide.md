...
```
✓ Scanning mui/material-ui repository...
...
**Import:** `import { Title } from '@design-system/components';`
**Example:**
```jsx
<Title size="l">
  <h2>Welcome Back</h2>
...
**Import:** `import { FieldPassword } from '@design-system/components';`
**Example:**
```jsx
<FieldPassword
...
Use `Form` and `FormRow` to structure the form with proper spacing.
```
...
**Input:** Figma URL
**Output:** List of components to use
**Time:** 3-10 seconds
**Cost:** Free
