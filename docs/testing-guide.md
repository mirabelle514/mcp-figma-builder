...
This guide shows you how to test each mode of the the design system-Figma MCP Server.
...
**Expected log output:**
```
the design system-Figma MCP Server starting...
Configured for repository: mui/material-ui
Using Supabase at: https://your-project.supabase.co
AI Mode: Component Mapping Only
the design system-Figma MCP Server running on stdio
```
...
```
Scan the design system repository
```

**Expected Response:**
```
I'll scan the design system repository and load the components...

[After scanning]
✓ Found XX components from mui/material-ui
...
**Expected Response:**
```
I'll analyze this Figma design and match it to components...
...
2. **FieldText**
   - Use for: [input name]
   - Import: import { FieldText } from '@design-system/components'
   ...
```
...
4. Get details about the Button component
```
...
**Check:**
1. REPO_OWNER and REPO_NAME are correct
