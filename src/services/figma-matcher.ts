/**
 * Figma to the design system Component Matcher
 * Analyzes Figma designs and matches them to existing the design system components
 */
...
export class FigmaMatcher {
  ...
  /**
   * Analyze Figma node and find matching the design system components
   */
  async matchNode(node: FigmaNode): Promise<ComponentMatch[]> {
   ...
   */
  async matchDesign(rootNode: FigmaNode): Promise<ComponentMatch[]> {
    const allMatches: ComponentMatch[] = [];
