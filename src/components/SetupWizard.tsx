      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                ...
                <div className="flex flex-wrap gap-3 justify-center text-xs">
                  <a
                    href="https://github.com/mirabelledoiron/mcp-starter-repo/blob/main/docs/user-guide.md"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://github.com/mirabelledoiron/mcp-starter-repo/blob/main/docs/troubleshooting.md"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://github.com/mirabelledoiron/mcp-starter-repo/blob/main/docs/setup-wizard.md"
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <div className="text-center mt-8 text-sm text-slate-600">
          ...
          <div className="flex flex-wrap gap-3 justify-center text-xs">
            ...
            <a
              href="https://github.com/mirabelledoiron/mcp-starter-repo/blob/main/docs/custom-ai-provider.md"
              target="_blank"
              rel="noopener noreferrer"
