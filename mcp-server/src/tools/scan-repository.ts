import { z } from 'zod';
import { ComponentScanner } from '../services/component-scanner.js';
import { DatabaseService } from '../services/db-service.js';

const ScanRepositoryInputSchema = z.object({});

export const scanRepositoryTool = {
...
export async function handleScanRepository(
  _args: z.infer<typeof ScanRepositoryInputSchema>,
