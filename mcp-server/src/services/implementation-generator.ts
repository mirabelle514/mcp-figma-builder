 ...
 * Generates implementation guides for using the design system components based on Figma designs
 */
...
export class ImplementationGenerator {
  ...
  private generateOverview(matches: ComponentMatch[]): string {
    ...
    return `This Figma design can be implemented using ${matches.length} existing the design system components: ${componentNames}.
...
Below is a step-by-step implementation guide with code examples.`;
  ...
  private generateFullCode(
    ...
    let code = '// Implementation using your design system components\n\n';
    code += imports.join('\n') + '\n\n';
