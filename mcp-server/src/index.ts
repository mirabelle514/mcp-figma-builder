...
import { scanRepositoryTool, handleScanRepository } from './tools/scan-repository.js';
  ...
  try {
    switch (request.params.name) {
      case 'scan_repository':
        return await handleScanRepository(request.params.arguments || {}, env);
